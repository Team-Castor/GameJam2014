...
public enum ObjectifType {
	...
	rapporterferAtelier(9), allerPuitPetrole(10), rapporterGenerateur(11), allerVersSortie(12), 
	allerVolerOutils(13), se_soigner(14), allezAuCombat(15), rendreArme(16), faireSemblant(17);
